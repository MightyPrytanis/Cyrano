import { legalComparator } from './src/tools/legal-comparator.js';

// Simple unit test for legal-comparator tool
console.log('Running legal-comparator unit tests...\n');
...
const result1 = legalComparator.performComparison(doc1, doc2, 'comprehensive');
...
const result2 = legalComparator.performComparison(doc1, doc2, 'comprehensive', ['liability']);
...
const struct1 = legalComparator.compareStructure(doc1, doc2);
console.log('Structural differences:', struct1);
console.log('✅ Test 3 passed\n');

// Test 4: Content analysis
console.log('Test 4: Content analysis');
const content1 = legalComparator.compareContent(doc1, doc2);
console.log('Content differences:', content1);
console.log('✅ Test 4 passed\n');

console.log('All legal-comparator tests passed! 🎉');
