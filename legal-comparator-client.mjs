 ...
 * Provides consistent access to the legal-comparator tool with full analysis
 */
...
Usage:
  node legal-comparator-client.js <doc1> <doc2> [analysis_type]
...
`);
  ...
  const client = new LegalComparatorClient();
